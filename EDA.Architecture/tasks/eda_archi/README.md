...
В этом домашнем задании мы с вами напишем небольшой проект по парсингу логов.
...
Посмотрите видосы с настройкой системой. Желательно работать в Professional Edition еcли у вас Windows, в других системах и Community хватает.

А почему так на Windows?

Потому что, в профессиональной версии можно поставить **WSL** а в обычной ее нет, будете страдать.
...
необходимо прожать в репозитории кнопочку `UPDATE FORK` **синего цвета**, после локально сделать ``git pull origin main ``
...
Реализовать **Этап 1** в той архитектуре что мы вам предложили (см.картинку)
